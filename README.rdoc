...
* Source: http://github.com/plribeiro3000/libvirt-ruby
* Issues: http://github.com/plribeiro3000/libvirt-ruby/issues
* Wiki: http://github.com/plribeiro3000/libvirt-ruby/wiki
...
This Gem is released but not all case was tested yet, so if you have some problem, feel free to create a new issue.
